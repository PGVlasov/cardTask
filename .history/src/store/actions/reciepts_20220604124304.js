...
export const loadCards = (cardId) => async (dispatch) => {
  try {
    const apiUrl = `https://shrouded-tundra-02503.herokuapp.com/https://bonus.evotor.tech/api/3rdparty/card/${cardId}/reciept`;
